...
import net.mcreator.perky.block.Arcikam1Block;
import net.mcreator.perky.PerkyModElements;

@PerkyModElements.ModElement.Tag
public class HaBiome extends PerkyModElements.ModElement {
	public static Biome biome;
	public HaBiome(PerkyModElements instance) {
		super(instance, 7);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-26215).setWaterColor(-52276).setWaterFogColor(-256)
						.withSkyColor(-26215).withFoliageColor(-65536).withGrassColor(-10027009).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.SLIME_BLOCK.getDefaultState(),
								Arcikam1Block.block.getDefaultState(), Arcikam1Block.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("perky:ha"));
			}
		}
	}
	@Override
