...
public class NecotakovehoBiome extends PerkyModElements.ModElement {
	public static Biome biome;
	public NecotakovehoBiome(PerkyModElements instance) {
		super(instance, 7);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-13369498).setWaterColor(-16724788).setWaterFogColor(-10066432)
						.withSkyColor(-13369498).withFoliageColor(-13369549).withGrassColor(-13421824)
						.setParticle(new ParticleEffectAmbience(ParticleTypes.SPLASH, 0.005f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.REDSTONE_LAMP.getDefaultState(),
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.DISK
								.withConfiguration(new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
										ImmutableList.of(Blocks.REDSTONE_LAMP.getDefaultState(), Blocks.SMOOTH_QUARTZ.getDefaultState())))
				...
				event.getRegistry().register(biome.setRegistryName("perky:necotakoveho"));
			}
		}
	}
	@Override
